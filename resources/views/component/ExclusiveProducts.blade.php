...
<script>
                                    ...
                                    <div class="product_img">
                                        ...
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li><a href="/product-detail?id=${item['id']}" class="popup-ajax"><i class="icon-magnifier-add"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="product_info">
                                        <h6 class="product_title"><a  href="/product-detail?id=${item['id']}">${item['title']}</a></h6>
    ...
    async function New() {
        let res = await axios.get("/list-product-remark/new");
        $("#NewItem").empty()
        res.data["data"].forEach((item, i)=>{
            let EachItem = `<div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
    ...
    async function Top() {
        let res = await axios.get("/list-product-remark/top");
        $("#TopItem").empty()
        res.data["data"].forEach((item, i)=>{
            let EachItem = `<div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
    ...
    async function Special() {
        let res = await axios.get("/list-product-remark/special");
        $("#SpecialItem").empty()
        res.data["data"].forEach((item, i)=>{
            let EachItem = `<div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
            ...
            $("#Special").append(EachItem);
        })
    }

    async function Trending() {
        let res = await axios.get("/list-product-remark/trending");
        $("#TrendingItem").empty()
        res.data["data"].forEach((item, i)=>{
            let EachItem = `<div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
